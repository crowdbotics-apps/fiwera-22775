"""fiwera_22775 URL Configuration
...
admin.site.site_header = "fiwera"
admin.site.site_title = "fiwera Admin Portal"
admin.site.index_title = "fiwera Admin"

# swagger
api_info = openapi.Info(
    title="fiwera API",
    default_version="v1",
    description="API documentation for fiwera App",
)
